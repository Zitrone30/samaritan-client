...
public class GameWebSocketClient implements WebSocket.Listener {
    ...
    public void updatePosition(double x, double y, double z, String dimension, String serverIp, String ign, int totemCount) {
        this.posX = x;
        this.posY = y;
        this.posZ = z;
        ...
        this.ign = ign;
        this.totemCount = Math.max(0, totemCount);
    ...
    private void sendPositionUpdate() {
        ...
        String message = String.format(
                "{\"token\":\"%s\",\"type\":\"position\",\"ign\":\"%s\",\"dimension\":\"%s\",\"serverIp\":\"%s\",\"totemCount\":%d,\"position\":{\"x\":%.0f,\"y\":%.0f,\"z\":%.0f}}",
                token, escapeJson(ign), escapeJson(dimension), escapeJson(serverIp), totemCount, roundedX, roundedY, roundedZ
        );
    ...
    public CompletionStage<?> onText(WebSocket webSocket, CharSequence data, boolean last) {
        try {
            ...
            if ("position".equals(type) && msg.has("position")) {
                ...
                int totemCount = msg.has("totemCount") ? Math.max(0, msg.get("totemCount").getAsInt()) : 0;
                ...
                if (positionListener != null) {
                    positionListener.onPositionUpdate(username, ign, x, y, z, dimension, serverIp, totemCount);
                }
    ...
    public interface PositionListener {
        void onPositionUpdate(String username, String ign, double x, double y, double z, String dimension, String serverIp, int totemCount);
